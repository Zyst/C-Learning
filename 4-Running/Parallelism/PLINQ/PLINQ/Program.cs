...
namespace PLINQ
{
    class Program
    {
        ...
        public static void Test1()
        {
            ...
            // LINQ query that retrieves all numbers that are greater than 100
            var over100 = numbers.AsParallel().Where(n => TestIfTrue(n > 100));

            // Another way to do the above with LINQ notation
            var over100Alt = from n in numbers.AsParallel()
            ...
            // Run the LINQ query and save the results in a List<int> object
        ...
        // The Thread.SpinWait(1000) deliberately slows down
        // the applciation so we can see the effects of parallelism.
        //
        // In fact, without it non-parallel is faster.
        ...
        public static void Test2()
        {
            ...
            try
            {
                // LINQ query that retrieves customers and orders from arrays
